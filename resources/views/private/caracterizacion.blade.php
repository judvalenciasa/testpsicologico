...
<body class="antialiased">
    ...
    <section class="caracterizacion_section">
        ...
        <form class="form_ctn" action="" method="POST">
            @csrf
            ...
            <div class="input-group">
                <label for="horas_redes">Cantidad de horas en redes sociales por semana:</label>
                <select id="horas_redes" name="horas_redes" required>
                    <option value="" disabled selected>Seleccione una opción</option>
                    <option value="1-10">1 a 10</option>
                    <option value="10+">Más de 10</option>
                </select>
            ...
            <!-- Cantidad de horas en videojuegos -->
            <div class="input-group">
                <label for="horas_videojuegos">Cantidad de horas en videojuegos por semana:</label>
                <select id="horas_videojuegos" name="horas_videojuegos" required>
                    <option value="" disabled selected>Seleccione una opción</option>
                    <option value="1-10">1 a 10</option>
                    <option value="10+">Más de 10</option>
                </select>
            ...
            <div class="input-group">
                <label for="horas_sueno">Cuántas horas suele dormir en las noches:</label>
            ...
            <!-- Práctica de deporte -->
            <div class="input-group">
                <label for="deporte">¿Práctica algún deporte de manera recurrente?</label>
            ...
            <!-- Práctica de arte -->
            <div class="input-group">
                <label for="arte">¿Practica algún arte como música, pintura o danza de manera recurrente?</label>
                <select id="arte" name="arte" required>
                    <option value="" disabled selected>Seleccione una opción</option>
                    <option value="Si">Sí</option>
                    <option value="No">No</option>
                </select>
            ...
            <div class="input-group">
                <label for="saludable">¿En su dieta incluye alimentos saludables?</label>
                <select id="saludable" name="saludable" required>
                    <option value="" disabled selected>Seleccione una opción</option>
                    <option value="Si">Sí</option>
                    <option value="No">No</option>
                </select>
