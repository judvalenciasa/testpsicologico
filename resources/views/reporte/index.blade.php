...
<body class="antialiased">
    ...
    <section>
        ...
        {{-- Sección de macrohabilidad inductiva --}}
        <div class="section">
        ...
        {{-- Sección de macrohabilidad abductiva --}}
        <div class="section">
        ...
        {{-- Sección de macrohabilidad deductivo y verbal --}}
        <div class="section">
        ...
        {{-- Sección de macrohabilidad análisis de argumentos --}}
        <div class="section">
        ...
        {{-- Sección de macrohabilidad toma de decisiones y resolución de problemas --}}
        <div class="section">
